...
{% include figure.liquid path="assets/img/blog/yodas_langs.png" class="img-fluid rounded z-depth-0" zoomable=true %}
<div class="caption">
...
{% include figure.liquid path="assets/img/blog/yodas_chars.png" class="img-fluid rounded z-depth-0" zoomable=true %}
<div class="caption">
...
{% include figure.liquid path="assets/img/blog/owsm_pipeline.png" class="img-fluid rounded z-depth-0" zoomable=true %}
<div class="caption">
...
{% include figure.liquid path="assets/img/blog/wavlablm.png" class="img-fluid rounded z-depth-0" zoomable=true %}
<div class="caption">
...
{% include figure.liquid path="assets/img/blog/mlsuperb_map.png" class="img-fluid rounded z-depth-0" zoomable=true %}
<div class="caption">
