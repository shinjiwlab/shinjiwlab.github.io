...
## Account creation
- Create an account for PSC on [ACCESS](https://allocations.access-ci.org/)
- Send the username to allocation managers (e.g. Xuankai) to add the user in our group.

## login
* check Connecting to Bridges-2 on https://www.psc.edu/resources/bridges-2/user-guide-2-2/
